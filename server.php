...
/*************************/
    ...
    function solicitar_descarga($cert64, $key64, $token,$rfc, $fechaInicial, $fechaFinal, $TipoSolicitud){
        ...
        $dataToHash = '<des:SolicitaDescarga xmlns:des="http://DescargaMasivaTerceros.sat.gob.mx"><des:solicitud RfcEmisor="" RfcReceptor="'.$rfc.'" RfcSolicitante="'.$rfc.'" FechaInicial="'.$fechaInicial.'" FechaFinal="'.$fechaFinal.'" TipoSolicitud="'.$TipoSolicitud.'"></des:solicitud></des:SolicitaDescarga>';
